...
export default function SqlEditor({ starterCode = "-- Write your SQL query here\nSELECT ", onSubmit }: SqlEditorProps) {
  ...
  return (
    <div className="flex h-full flex-col overflow-hidden rounded-xl border border-gray-800">
